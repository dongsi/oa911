<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="filemanager.aspx.cs" Inherits="files_filemanager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:FileUpload ID="FileUpload1" Runat="server" Width="591px" />
    ...
    <hr />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO ob_UploadFile(UploadFileId, UploadUserId, LocalFileName, RemoteFileName, FileSize, UploadDate, Filetype) VALUES (?, ?, ?, ?, ?, ?,)" 
            ProviderName="<%$ ConnectionStrings:ConnectionStringGridView.ProviderName %>" 
            SelectCommand="SELECT  UploadFileId,LocalFileName,RemoteFileName,FileSize,UploadDate ,Filetype ,weekdays,UserFullName,remark FROM v_uploadfile where (filetype=? ) ORDER BY UploadDate DESC" 
