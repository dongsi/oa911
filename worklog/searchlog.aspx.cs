...
public partial class worklog_searchlog : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("logreportview.aspx?date1=" + BeginDate.Text + " 00:00:00" + "&date2=" + EndDate.Text + " 23:59:59&selectuserid=" + DropDownList1.SelectedValue.ToString());
    }
}